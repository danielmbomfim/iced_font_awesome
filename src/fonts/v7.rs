...
pub(crate) const REGULAR_FONT_DATA: &[u8] =
    include_bytes!("../../assets/font-awesome-7/otfs/font-awesome-7-free-regular-400.otf");

pub(crate) const BRANDS_FONT_DATA: &[u8] =
    include_bytes!("../../assets/font-awesome-7/otfs/font-awesome-7-brands-regular-400.otf");

pub(crate) const SOLID_FONT_DATA: &[u8] =
    include_bytes!("../../assets/font-awesome-7/otfs/font-awesome-7-free-solid-900.otf");
...
pub(crate) const BRANDS_FONT: Font = Font {
    family: Family::Name("Font Awesome 7 Brands"),
    ..Font::DEFAULT
};
